      ...
      return function() {
        ...
        return function() {
          ...
          var u = { copyStyles: true, pageStyle: "\n        @page {\n            /* Remove browser default header (title) and footer (url) */\n            margin: 0;\n        }\n        @media print {\n            body {\n                /* Tell browsers to print background colors */\n                -webkit-print-color-adjust: exact; /* Chrome/Safari/Edge/Opera */\n                color-adjust: exact; /* Firefox */\n            }\n        }\n    ", removeAfterPrint: false, suppressErrors: false }, l = function(e3) {
            function o2() {
              ...
              return r3.startPrint = function(e4) {
                ...
                setTimeout(function() {
                  var t4, c2;
                  if (e4.contentWindow) if (e4.contentWindow.focus(), i2) i2(e4).then(function() {
                    ...
                    } else r3.logMessages(["Printing for this browser is not currently possible: the browser does not have a `print` method available for iframes."]);
                    null == n3 || n3(), r3.handleRemoveIframe();
                  }
                  else r3.logMessages(["Printing failed because the `contentWindow` of the print iframe did not load. This is possibly an error with `react-to-print`. Please file an issue: https://github.com/gregnb/react-to-print/issues/"]);
                }, 500);
                ...
                if (void 0 !== l2) if (null !== l2) {
                  ...
                  if (d) {
                    ...
                    f.onload = function() {
                      ...
                      if (y2) {
                        ...
                        if ("string" != typeof g2) r3.logMessages(['"react-to-print" expected a "string" from `pageStyle` but received "'.concat(typeof g2, '". Styles from `pageStyle` will not be applied.')]);
                        else {
                        ...
                        if (o3 && (e5 = y2.body.classList).add.apply(e5, t2.__spreadArray([], t2.__read(o3.split(" ")), false)), !h) {
                          ...
                          var x = function(e6) {
                            ...
                            } else m(t3, ['Found an <img> tag with an empty "src" attribute. This prevents pre-loading it. The <img> is:', t3]);
                          };
                          ...
                          var j = function(e6) {
                            ...
                            } else t3.readyState >= 2 ? m(t3) : (t3.onloadeddata = function() {
                              return m(t3);
                        ...
                        if (a2) for (var F = document.querySelectorAll("style, link[rel~='stylesheet'], link[as='style']"), L = function(e6, t3) {
                          var n4 = F[e6];
                          if ("style" === n4.tagName.toLowerCase()) {
                            ...
                            if (i4) {
                              var a3 = "";
                              try {
                                for (var c3 = i4.cssRules.length, s3 = 0; s3 < c3; ++s3) "string" == typeof i4.cssRules[s3].cssText && (a3 += "".concat(i4.cssRules[s3].cssText, "\r\n"));
                              } catch (e7) {
                          ...
                          } else if (n4.getAttribute("href")) if (n4.hasAttribute("disabled")) r3.logMessages(["`react-to-print` encountered a <link> tag with a `disabled` attribute and will ignore it. Note that the `disabled` attribute is deprecated, and some browsers ignore it. You should stop using it. https://developer.mozilla.org/en-US/docs/Web/HTML/Element/link#attr-disabled. The <link> is:", n4], "warning"), m(n4);
                          else {
                          ...
                          else r3.logMessages(["`react-to-print` encountered a <link> tag with an empty `href` attribute. In addition to being invalid HTML, this can cause problems in many browsers, and so the <link> was not loaded. The <link> is:", n4], "warning"), m(n4);
                  ...
                  } else r3.logMessages(['"react-to-print" could not locate the DOM node corresponding with the `content` prop']);
                } else r3.logMessages(['There is nothing to print because the "content" prop returned "null". Please ensure "content" is renderable before allowing "react-to-print" to be called.']);
                else r3.logMessages(["To print a functional component ensure it is wrapped with `React.forwardRef`, and ensure the forwarded ref is used. See the README for an example: https://github.com/gregnb/react-to-print#examples"]);
            ...
            return t2.__extends(o2, e3), o2.prototype.render = function() {
              ...
              if (n3) return r2.cloneElement(n3(), { onClick: this.handleClick });
          ...
          e2.default = l, e2.useReactToPrint = function(e3) {
            if (!c) return e3.suppressErrors || console.error('"react-to-print" requires React ^16.8.0 to be able to use "useReactToPrint"'), function() {
